...
class GalleryTypeController extends BackEndController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('GalleryType');
	...
	{
		$model=GalleryType::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param GalleryType $model the model to be validated
	 */
