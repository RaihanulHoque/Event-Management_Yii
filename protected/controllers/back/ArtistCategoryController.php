...
class ArtistCategoryController extends BackEndController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('ArtistCategory');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='artist-category-form')
		{
