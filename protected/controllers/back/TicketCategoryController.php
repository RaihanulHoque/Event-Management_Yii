...
class TicketCategoryController extends BackEndController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('TicketCategory');
	 ...
	 * @param TicketCategory $model the model to be validated
	 */
