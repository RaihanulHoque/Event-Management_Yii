...
<div class="page-header">
	<h1>
		<i class="ace-icon fa fa-th-large"></i> Galleries
		<small>
 ...
 <div class="col-xs-12 col-sm-12 widget-container-col ui-sortable" id="widget-container-col-1" style="min-height: 210px;">
		<div class="widget-box ui-sortable-handle" id="widget-box-1" style="opacity: 1;">
			<div class="widget-header">
				<h5 class="widget-title smaller"> <span style="font-weight:600;"><?php //echo $model->activity_title; ?>Manage Gallery</span> </h5>
	...
	/*	'id',
		...
		*/						
							...
							array(
								'name' => 'gallery_type',
								'type' => 'raw',
								'value' => 'GalleryType::getData($data->gallery_type, "title")',
								'filter' => CHtml::activeDropDownList($model, 'gallery_type', CHtml::listData(GalleryType::model()->findAll(array('condition' => '', "order" => "title")), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
								'htmlOptions' => array('style' => "text-align:left;width:100px;"),
							),
							array(
								'name'=>'number_of_floor',
								'value'=>'$data->number_of_floor',       
								'htmlOptions' => array('style' => "text-align:center; width:100px !important;", 'title' => 'ID'),
							 ),	
							 array(
								'name'=>'total_capacity',
