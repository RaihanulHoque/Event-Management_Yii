					...
					<div class="row">
						<div class="col-xs-12">
							<div class="tabbable">
								...
								<?php
									$resultUnreadEmail=MailCustomer::model()->findAllBySql("select * from arm_mail_customer where mail_status=1 and customer_id=$customer_id and created_by <> $customer_id"); 
								...
								<div class="tab-content no-border no-padding">
									<div id="inbox" class="tab-pane in active">
										<div class="message-container">
											...
											<?php
												$resultUnreadEmail=mailCustomer::model()->findAllBySql("select * from arm_mail_customer where customer_id=$customer_id"); 
												$count_val=count($resultUnreadEmail);
											?>
